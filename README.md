...
| 角色 | 姓名（学号）         | 职责                                                         |
| ---- | -------------------- | ------------------------------------------------------------ |
| 组长 | *******   | 统筹项目、撰写项目报告、设计UI与前端框架、实现后端查找与替换的部分功能、实现打开与新建文本的部分功能、实现撤销与重做的数据接口、测试项目与debug、TextEdit类的继承框架、录制视频等 |
| 组员 | *******   | 设计UI与前端框架、实现后端查找与替换的部分功能、实现打开与新建文本的部分功能、实现保存与另存为、测试项目与debug等 |
| 组员 | *******   | 实现字体设置与格式设置功能、实现了查找与替换部分功能、实现了剪贴板功能、实现了查找与替换部分功能、测试项目与debug等 |
